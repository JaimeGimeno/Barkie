//Barkie Logo
#define Barkie_Dog_width 82
#define Barkie_Dog_height 64
static unsigned char Barkie_Dog_bits[] = {
...
void draw_BarkieDog(void) {
  
 u8g2.firstPage();
 u8g2.drawXBMP( 24, 0, Barkie_Dog_width, Barkie_Dog_height, Barkie_Dog_bits);
 while( u8g2.nextPage() );
